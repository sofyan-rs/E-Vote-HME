...
if(isset($_GET['pesan'])){
    if($_GET['pesan'] == "gagal"){
        echo'<div class="alert alert-danger alert-dismissable" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><i class="fa fa-fw fa-exclamation-circle"></i> Username dan Password tidak sesuai</div>';
    }
...
?>
<form class="js-validation-signin" action="<?php echo $url; ?>admin/login_check.php" method="POST">
<div class="py-3">
