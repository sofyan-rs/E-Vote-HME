...
<h1 class="flex-sm-fill h3 my-2">Tambah Calon</h1>
<nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
<ol class="breadcrumb breadcrumb-alt">
<li class="breadcrumb-item">Dashboard</li>
<li class="breadcrumb-item" aria-current="page">
<a class="link-fx" href="">Tambah Calon</a>
</li>
</ol>
</nav>
</div>
...
<form action="<?php echo $url; ?>admin/tambah_calon_action.php" method="POST" enctype="multipart/form-data">
...
<textarea class="form-control form-control-alt" id="visimisi" name="visimisi" rows="4" placeholder="Visi Misi"></textarea>
</div>
<div class="form-group">
<label for="progul">Program Unggulan</label>
<textarea class="form-control form-control-alt" id="progul" name="progul" rows="4" placeholder="Program Unggulan"></textarea>
</div>
<div class="form-group">
<label for="foto">Link Foto</label>
<textarea class="form-control form-control-alt" id="foto" name="foto" rows="2" placeholder="Link Foto"></textarea>
</div>
